...
# Appel le script de shoot de timelapse PUIS celui qui produit la video mp4.

# Exemples :

# Nuit
# projects/timelapse/auto_tl.sh 30000 9999999 matrix auto 800 600 5 off 55 0 &

# 9h de folie
# /home/pi/projects/timelapse/auto_tl.sh 8000 57600000 matrix auto 800 600 5 off 55 0 &
...
folderDate="remotl$DATE" # Nom du dossier de travail
...
/home/pi/projects/timelapse/tl.sh $1 $2 $3 $4 $5 $6 $7 $8 $9 &

# C'est parti pour la video du timelapse
# projects/timelapse/manu_avconv.sh $fullpath