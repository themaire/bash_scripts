...
raspistill --nopreview -w $5 -h $6 -q $7 -o /mnt/cle/tl/pic2%04d.jpg -tl $1 -t $2 -th 0:0:0 -rot 180 -mm $3 -ex $4 -drc $8 -br $9 -ev 0 &

##
# ou bien :
#raspistill --nopreview -w $5 -h $6 -q $7 -o /home/pi/Pictures/timelapse/pic3%04d.jpg -tl #$1 -t $2 -th 0:0:0 -rot 270 -mm $3 -ex $4 -drc $8 -br $9 -ev 0 &